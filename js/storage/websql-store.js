var WebSqlStore = function(successCallback, errorCallback) {
    ...
    this.createTable = function(tx) {
        tx.executeSql('DROP TABLE IF EXISTS tuktukmaster');
        var sql = "CREATE TABLE IF NOT EXISTS tuktukmaster ( " +
    ...
    this.addSampleData = function(tx, employees) {
        var employees = [
                {"id": 1, "nickName": "Viluredfish", "lastName": "Howard", "title":"Vice President, North East", "managerId": 0, "city":"New York, NY", "cellPhone":"212-999-8888", "officePhone":"212-999-8887", "email":"ryan@dundermifflin.com"}
            ];
